class RegistersController < ApplicationController
  before_filter :authenticate_user!, :except => [:index, :contacts]
  before_action :set_register, only: [:show, :edit, :update, :destroy]

  # GET /registers
  # GET /registers.json
  def index
    @search=Register.search(params[:q])
    @registers = @search.result
  end
  ...
  private
    ...
    def register_params
      params.require(:register).permit(:First_name, :Last_name, :Age, :Address, :Education, :Occupation, :Photo, :image)
    end
end
